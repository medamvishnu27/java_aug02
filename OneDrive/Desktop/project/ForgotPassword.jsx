...
import { sendPasswordResetEmail, clearError } from '../../redux/slices/authSlice';
...
const ForgotPassword = () => {
  ...
  const [localError, setLocalError] = useState(null); // Local state for errors not managed by Redux
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const errorMessage = error || 'Failed to send reset email. Please try again.';
